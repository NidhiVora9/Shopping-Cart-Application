...
<div class="jumbotron">
    <table>
        ...
        <tr>
            <td>
                <asp:Button ID="btnCancel" CssClass="mainButton" runat="server" Text="Button" />
            </td>
            <td>
                <asp:Button ID="btnUpdate" CssClass="mainButton" runat="server" Text="Button" OnClick="btnUpdate_Click" />
            </td>
        </tr>
        <tr>
            <td>
