    ...
    <div id="content_box">
       <table id="content_center_box" style="border-spacing: 20px">
            <tr>
                ...
                <label class="lblheading">Existing Customers:LOGIN</label>
                </td>
            </tr>
            <tr>
           ...
           <tr>
               <td>
                New Customers Please <asp:HyperLink ID="reglink" NavigateUrl="NewCustomerReg.aspx" runat="server">Register</asp:HyperLink>
               </td>
           </tr>
            <tr style="text-align: center">
